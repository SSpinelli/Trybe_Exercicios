# Às vezes, você precisa fazer com que o seu raspador da Web
# pareça estar fazendo solicitações HTTP como o navegador,
# para que o servidor retorne os mesmos dados que você vê
# no seu navegador. Faça uma requisição a
...
# Faça a inspeção de como a requisição é feita pelo navegador
